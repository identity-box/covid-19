...
class MultiTelepathConfiguration {
  ...
  readConfigurationFromEnvironment = () => {
    ...
    const telepathConfiguration = {
      id: process.env.GATSBY_telepath_idbox_id,
      key: process.env.GATSBY_telepath_idbox_key,
      appName: process.env.GATSBY_telepath_idbox_appname,
      servicePointId: process.env.GATSBY_telepath_idbox_servicepointid
    }
    console.log('TELEPATH CONFIGURATION:', telepathConfiguration)
